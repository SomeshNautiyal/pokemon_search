...
export default async function PokemonDetailPage({
  ...
  return (
    <div className=" min-h-screen flex flex-col items-center">
      <div className="mb-6 w-full max-w-4xl ml-auto pr-4 flex items-center justify-between">
        <BackButton />
        <div className="text-blue-700 w-full text-sm my-4 pr-4 flex items-center justify-end">
      ...
      <div className="max-w-100 bg-white shadow-lg flex flex-col items-center mx-auto my-30 rounded-xl ml-auto">
        <div className="w-full bg-[#60e2c9] flex justify-center items-center p-6 rounded-t-xl">
          <Image
            src={
        ...
        <div className="w-full bg-[#fdc666] p-6 text-black text-left rounded-b-xl">
          <p className="mt-2">
